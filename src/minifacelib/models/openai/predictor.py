"""OpenAI-backed face predictor implementation."""
...
class OpenAIFacePredictor(FacePredictor):
    """Face predictor that delegates inference to an OpenAI vision model."""

    MODEL_NAME: ClassVar[str] = "openai"

    def __init__(self, model: str = "gpt-5.2"):
        """Initialize the predictor with the given OpenAI model name."""
        self._model = model
    ...
    def predict(self, image: Image.Image) -> FacePrediction:
        """Run face prediction using the OpenAI API."""
