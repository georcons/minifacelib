"""CNN model for joint gender classification and age regression."""
...
class GenderAgeModel(nn.Module):
    """Convolutional neural network with shared backbone and two output heads."""
    ...
    def forward(self, x):
        """Compute gender logits and age prediction from input images."""
